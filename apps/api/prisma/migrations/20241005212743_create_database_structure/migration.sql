...
-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_organizatio_id_fkey" FOREIGN KEY ("organizatio_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
